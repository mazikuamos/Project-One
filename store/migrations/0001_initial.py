# Generated by Django 4.1.5 on 2023-01-17 08:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mebership', models.CharField(choices=[('B', 'Brozen'), ('S', 'Siliver'), ('G', 'Gold')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pendig'), ('C', 'Complete'), ('F', 'Failed')], default='P', max_length=1)),
